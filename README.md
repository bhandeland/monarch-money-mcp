...
| Investments | `get_portfolio`, `search_securities`, `get_security`, `get_security_performance`, `get_security_types`, `get_allocation_categories`, `create_manual_holding`, `update_holding`, `delete_holding`, `create_manual_investments_account`, `set_holding_classification`, `set_security_classification`, `clear_holding_classification`, `clear_security_classification` |
| Business and Schedule C | `get_business_entities`, `get_business_entity`, `get_business_entity_financials`, `get_business_entity_summaries`, `create_business_entity`, `update_business_entity`, `delete_business_entity`, `set_account_business_entity`, `get_schedule_c_line_items`, `get_schedule_c_category_mappings`, `set_schedule_c_category_mapping`, `delete_schedule_c_category_mapping` |
...
| Budget moves and flex | `get_budget_settings`, `move_budget_money`, `set_flex_budget_amount`, `update_budget_settings`, `reset_budget_rollover` |
